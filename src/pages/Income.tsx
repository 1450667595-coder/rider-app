  ...
  return (
    <motion.div className="px-4 pt-6 pb-24 space-y-5" variants={container} initial="hidden" animate="show">
      ...
      <motion.div variants={item} className="text-center">
        <p className="terminal-text text-sm tracking-tight">{year}年{month}月</p>
        ...
        <p className="terminal-text text-xs mt-1 tracking-tight">本月累计收入</p>
      </motion.div>
      ...
      <motion.div variants={item} className="grid grid-cols-3 gap-3">
        <div className="holo-card rounded-[26px] p-4">
          ...
          <p className="terminal-text text-[10px] mt-0.5">上月 ¥{prevMonthIncome.toLocaleString()}</p>
        </div>
        <div className="holo-card rounded-[26px] p-4">
          <div className="flex items-center gap-1.5 mb-2">
